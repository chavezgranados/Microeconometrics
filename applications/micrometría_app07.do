...
*====================================================================================
* Tópico 07: Modelos Tobit
*==================================================================================== 
* Fuente: Cameron & Trivedi, "Microeconometrics Using Stata" 
* Stata Press 
...
* Parte I : Ejemplo de modelo tobit
*-------------------------------------------------------------------------------
...
matrix bcoeff = btobit[1,1..e(df_m)] // bcoeff is betas excl. constant
...
matrix list deriv 
* The following gives nicer looking result 
ereturn post deriv 
ereturn display

* Compute mfx on Pr(5000<ambexp<10000)  
quietly tobit ambexp $xlist, vce(robust) ll(0) 
mfx compute, predict(pr(5000,10000))




* Parte II : Tobit para datos lognormales
*-------------------------------------------------------------------------------
...
* Parte III : Modelos en dos partes
*-------------------------------------------------------------------------------
...
* Parte II : Predicción de modelos con respuest en log
*-------------------------------------------------------------------------------

// The following yields results that differ from book - book is in error
* Prediction from tobit on lny (using scalars and variables from 16.4)
